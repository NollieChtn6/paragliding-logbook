...
// Bouton de fermeture en croix, en coin (pas dans le footer) : ce dialogue
// n'a pas d'action destructive à confirmer/annuler comme AlertDialog, la
// fermeture doit rester accessible sans dépendre du footer.
