...
export function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    // overflow-hidden sans condition de largeur, sinon la sidebar (desktop)
    // ou le header/la rangée d'onglets (mobile) défilaient avec le contenu
    // dès qu'une page (ex. liste des sites) dépassait la hauteur d'écran.
    <div className="flex h-svh overflow-hidden">
      ...
      <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
        ...
        <main className="mx-auto w-full max-w-4xl flex-1 overflow-y-auto p-4 pb-8 md:p-6">
          {children}
        </main>
      </div>
    </div>
