...
// La liste des types d'activité et des sites doit toujours refléter l'état
// actuel de la base, pas un instantané figé au build.
export const dynamic = "force-dynamic";

export default async function NewActivityPage() {
  const [activityTypes, sites] = await Promise.all([
  ...
  return (
    <div className="mx-auto flex min-h-svh w-full max-w-md flex-col gap-6 px-4 py-8">
      ...
      <NewActivityForm activityTypes={activityTypes} sites={sites} />
    </div>
  );
}
