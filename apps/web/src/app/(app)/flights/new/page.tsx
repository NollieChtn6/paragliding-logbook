...
// Les stages/le matériel proposés doivent toujours refléter l'état actuel
...
export default async function NewFlightPage(props: PageProps<"/flights/new">) {
  ...
  const [flightTypes, trainingCamps, equipment, duplicateSource] = await Promise.all([
  ...
  // vol, pas une copie de la narration d'un autre. Idem pour le matériel :
  // pas repris, un vol dupliqué n'assume pas que la même voile a été
  // réutilisée.
