...
// formulaires d'activité) : utilisé en création (/admin/sites/new) et en
// modification (/admin/sites/[id]/edit), action et defaultValues varient
// selon l'appelant — même principe que FlightForm/TrainingCampForm.
export function SiteForm({ action, defaultValues, submitLabel = "Créer le site" }: SiteFormProps) {
