...
- `/activities/new` : choix du type d'activité (Vol/Stage/Gonflage) puis formulaire — seul Vol est implémenté, les deux autres affichent "Bientôt disponible". **Protégée.**
